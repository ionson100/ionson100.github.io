...
export function IndexBsrMenu(){
    ...
    return (
        <>
            ...
            <tr>
                <td data-d>popupClassName</td>
                <td>string</td>
                <td>'popup-123' </td>
                <td>css class for submenu panel</td>
            </tr>
            <tr>
                <td data-d>dataUser</td>
                <td>string | undefined</td>
                <td>undefined</td>
            ...
            <tr>
                <td data-d> content</td>
                <td>any</td>
                <td>'undefined'</td>
                <td>The visual content of the menu consists of three horizontal areas: contentLeft - content - contentRight. Can be determined individually.</td>
            </tr>
            <tr>
                <td data-d> contentRight</td>
                <td>any</td>
                <td>'undefined'</td>
                <td>The visual content of the menu consists of three horizontal areas: contentLeft - content - contentRight. Can be determined individually.</td>
            </tr>
            <tr>
                <td data-d><a href="#mode=bsrmenu&page=1-4">disabled</a></td>
                <td>bool</td>
                <td>false</td>
            ...
            <table style={{width:"80%"}}>
                ...
                <tr  >
                    <td data-d>CloseMenu(callback)</td>
